...
PanelWindow {
    ...
    WlrLayershell.keyboardFocus: AppLauncherState.launcherVisible
    ...
    Item { id: maskCover; anchors.fill: parent }
    ...
    Rectangle {
        ...
        MouseArea {
            ...
            onWheel: function(wheel) {
                if (wheel.angleDelta.y < 0) root.navigate(1)
                else root.navigate(-1)
            }
        }
        ...
        Column {
            ...
            Rectangle {
                ...
                Row {
                    ...
                    Text {
                        text: ""
                        color: Colors.colFg; opacity: 0.40
                    ...
                    Item {
                        ...
                        Text {
                            ...
                            color: Colors.colFg; opacity: 0.28
                            font { pixelSize: 13; family: "JetBrainsMono Nerd Font" }
                        ...
                        TextInput {
                            ...
                            Keys.onPressed: function(event) {
                                if (event.key === Qt.Key_Up) {
                                    root.navigate(-1); event.accepted = true
                                    ...
                                    AppLauncherState.hide(); event.accepted = true
                                }
                            }
                        }
                    }
            ...
            ListView {
                ...
                delegate: Item {
                    ...
                    readonly property bool isRecent: !root.isSearching
                        && AppLauncherState.recentIds.indexOf(modelData.id) !== -1
                        && AppLauncherState.recentIds.indexOf(modelData.id) < 5
                        ...
                        Row {
                            ...
                            Rectangle {
                                ...
                                Text {
                                    ...
                                    font { pixelSize: 15; family: "JetBrainsMono Nerd Font"; weight: Font.Bold }
                            ...
                            Column {
                                ...
                                Row {
                                    ...
                                    Text {
                                        ...
                                        color: Colors.colFg; opacity: 0.35
                                        anchors.verticalCenter: parent.verticalCenter
                                    }
                                }
                            }
