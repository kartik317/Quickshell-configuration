...
PanelWindow {
    ...
    Rectangle {
        ...
        RowLayout {
            ...
            VSliderBlock {
                ...
                iconText: SystemState.volumeMuted ? "\uf026" : SystemState.volumeLevel > 60 ? "\uf028" : "\uf027"
                label: "Vol"
    ...
    component VSliderBlock: ColumnLayout {
        ...
        Rectangle {
            ...
            height: 34
            radius: 10
            color: block.muted ? Qt.alpha(Colors.colRed, 0.25) : Qt.alpha(Colors.colBlue, 0.18)
            Behavior on color {
                ColorAnimation {
                    duration: 180
                }
        ...
        Item {
            ...
            Rectangle {
                ...
                color: dragArea.pressed ? Colors.colPurple : block.muted ? Colors.colBlack : Colors.colBlue
            ...
            MouseArea {
                ...
                function valueFromY(my) {
                    const clamped = Math.max(handle.height / 2, Math.min(sliderItem.height - handle.height / 2, my));
                ...
                onPositionChanged: mouse => {
                    if (pressed)
                        block.slide(valueFromY(mouse.y));
                }
            }
        }
